...
/**
 * Show Plugin Information in Page Module to every js_greetingcards content element
 *
...
class PluginInformation {
	 ...
	 * @var string
	 */
	protected $locallangPath = 'LLL:EXT:js_greetingcards/Resources/Private/Language/locallang-plugin-information.xlf:';
	...
	public function build($params = array()) {
		...
		$imagePath = $this->getSubFolderOfCurrentUrl().'typo3conf/ext/js_greetingcards/Resources/Public/Icons/plugin-information.png';
	...
	protected function getLabelsAndValues($params) {
		$array = array(
			$this->getLocalizedLabel('receiverName') => $this->getFieldFromFlexform($params,'receiver', 'flexform.receiver.name'),
			$this->getLocalizedLabel('receiverEmail') => $this->getFieldFromFlexform($params,'receiver', 'flexform.receiver.email'),
			$this->getLocalizedLabel('receiverSubject') => $this->getFieldFromFlexform($params,'receiver', 'flexform.receiver.subject'),
		);
