...
/**
 * Test case for class TYPO3\Events\Controller\EventsController.
 *
 */
class EventsControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase
{
	...
	/**
	 * @var \TYPO3\Events\Controller\EventsController
	 */
	protected $subject = NULL;

	public function setUp()
	{
		$this->subject = $this->getMock('TYPO3\\Events\\Controller\\EventsController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllEventssFromRepositoryAndAssignsThemToView()
	{
		...
		$eventsRepository = $this->getMock('TYPO3\\Events\\Domain\\Repository\\EventsRepository', array('findAll'), array(), '', FALSE);
	...
	{
		$events = new \TYPO3\Events\Domain\Model\Events();
