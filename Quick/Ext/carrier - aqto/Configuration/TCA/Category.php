...
$GLOBALS['TCA']['tx_karriere_domain_model_category'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_karriere_domain_model_category']['ctrl'],
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, subtitle, preview, image, files, description',
	),
	'types' => array(
