...
/**
 * Test case for class JS\JsEvent\Controller\EventController.
 *
 */
class EventControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \JS\JsEvent\Controller\EventController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('JS\\JsEvent\\Controller\\EventController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllEventsFromRepositoryAndAssignsThemToView() {
		...
		$eventRepository = $this->getMock('JS\\JsEvent\\Domain\\Repository\\EventRepository', array('findAll'), array(), '', FALSE);
