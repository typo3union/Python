...
/**
 * Test case for class \Arzte\Arzte\Domain\Model\DoctoreList.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class DoctoreListTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Arzte\Arzte\Domain\Model\DoctoreList
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Arzte\Arzte\Domain\Model\DoctoreList();
	}
