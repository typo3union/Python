...
/**
 * Test case for class Arzte\Arzte\Controller\CategoryController.
 *
 */
class CategoryControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \Arzte\Arzte\Controller\CategoryController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('Arzte\\Arzte\\Controller\\CategoryController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllCategoriesFromRepositoryAndAssignsThemToView() {
		...
		$categoryRepository = $this->getMock('Arzte\\Arzte\\Domain\\Repository\\CategoryRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenCategoryToView() {
		$category = new \Arzte\Arzte\Domain\Model\Category();
