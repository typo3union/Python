...
/**
 * Test case for class \Typo3\Course\Domain\Model\Subcategory.
 *
 ...
 */
class SubcategoryTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	 * @var \Typo3\Course\Domain\Model\Subcategory
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = new \Typo3\Course\Domain\Model\Subcategory();
	}
