...
/**
 * Test case for class \Typo3\Course\Domain\Model\Durations.
 *
 ...
 */
class DurationsTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	...
	protected function setUp() {
		$this->subject = new \Typo3\Course\Domain\Model\Durations();
	}
