...
$GLOBALS['TCA']['tx_jscontactform_domain_model_contactform'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, firstname, email, phone, message, subject, page, contact_date, ip, useragent',

	),

	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, firstname, email, phone, message, subject, page, contact_date, ip, useragent, --div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access, starttime, endtime'),
