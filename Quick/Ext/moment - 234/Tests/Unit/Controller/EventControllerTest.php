...
/**
 * Test case for class TYPO3\Augenblicke\Controller\EventController.
 *
 */
class EventControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {

	/**
	 * @var \TYPO3\Augenblicke\Controller\EventController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('TYPO3\\Augenblicke\\Controller\\EventController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllEventsFromRepositoryAndAssignsThemToView() {
		...
		$eventRepository = $this->getMock('TYPO3\\Augenblicke\\Domain\\Repository\\EventRepository', array('findAll'), array(), '', FALSE);
	...
	public function showActionAssignsTheGivenEventToView() {
		$event = new \TYPO3\Augenblicke\Domain\Model\Event();
