...
/**
 * Test case for class TYPO3\Events\Controller\CategoryController.
 *
...
class CategoryControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \TYPO3\Events\Controller\CategoryController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('TYPO3\\Events\\Controller\\CategoryController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllCategoriesFromRepositoryAndAssignsThemToView() {
		...
		$categoryRepository = $this->getMock('TYPO3\\Events\\Domain\\Repository\\CategoryRepository', array('findAll'), array(), '', FALSE);
