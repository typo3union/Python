...
/**
 * Test case for class TYPO3\Events\Controller\LocationController.
 *
...
class LocationControllerTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	...
	/**
	 * @var \TYPO3\Events\Controller\LocationController
	 */
	protected $subject = NULL;

	protected function setUp() {
		$this->subject = $this->getMock('TYPO3\\Events\\Controller\\LocationController', array('redirect', 'forward', 'addFlashMessage'), array(), '', FALSE);
	}
	...
	public function listActionFetchesAllLocationsFromRepositoryAndAssignsThemToView() {
		...
		$locationRepository = $this->getMock('TYPO3\\Events\\Domain\\Repository\\LocationRepository', array('findAll'), array(), '', FALSE);
