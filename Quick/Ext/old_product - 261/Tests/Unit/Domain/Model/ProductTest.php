...
class ProductTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	 ...
	 * @test
	 */
	public function getMachineNoReturnsInitialValueForString() {
		$this->assertSame(
			'',
			$this->subject->getMachineNo()
		);
	}
	 ...
	 * @test
	 */
	public function setMachineNoForStringSetsMachineNo() {
		$this->subject->setMachineNo('Conceived at T3CON10');
