...
/**
 * Test case for class \JS\JsDownload\Domain\Model\Filetype.
 *
 * @copyright Copyright belongs to the respective authors
 * @license http://www.gnu.org/licenses/gpl.html GNU General Public License, version 3 or later
 *
 */
class FiletypeTest extends \TYPO3\CMS\Core\Tests\UnitTestCase {
	/**
	...
	protected function setUp() {
		$this->subject = new \JS\JsDownload\Domain\Model\Filetype();
	}
