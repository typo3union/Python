...
$GLOBALS['TCA']['tx_newsletter_domain_model_newsletter'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_newsletter_domain_model_newsletter']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_newsletter_domain_model_newsletter.pid=###CURRENT_PID### AND tx_newsletter_domain_model_newsletter.sys_language_uid IN (-1,0)',
			),
		),
