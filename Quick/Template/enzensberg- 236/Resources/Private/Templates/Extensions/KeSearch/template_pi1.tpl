...
<form method="get" id="xajax_form_kesearch_pi1" name="xajax_form_kesearch_pi1"  action="###FORM_ACTION###" class="static navbar-form" ###ONSUBMIT###>
	<input type="hidden" name="id" value="###FORM_TARGET_PID###" />
	###HIDDENFIELDS###
	<div class="input-group">
   <input type="text" class="input-box search" id="ke_search_sword" name="tx_kesearch_pi1[sword]" value="###SWORD_VALUE###" placeholder="###SEARCHBOX_DEFAULT_VALUE###" onfocus="###SWORD_ONFOCUS###" onblur="###SWORD_ONBLUR###"/>
 		<span class="input-group-btn">
        	<input type="submit" id="kesearch_submit"   class="button-search" onclick="document.getElementById('pagenumber').value=1; document.getElementById('xajax_form_kesearch_pi1').submit();" value=""/>
