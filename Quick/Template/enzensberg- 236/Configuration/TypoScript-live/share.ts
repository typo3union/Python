...
lib.share.social.value = <ul><li><a href="#"><img src="typo3conf/ext/enzensberg/Resources/Public/images/s-icon.png" alt="img" /></a></li><li><a href="{$share.url.facebook}"><img src="typo3conf/ext/enzensberg/Resources/Public/images/fb-icon.png" alt="img" /></a></li><li><a href="{$share.url.youtube}"><img src="typo3conf/ext/enzensberg/Resources/Public/images/youtb-icon.png" alt="img" /></a></li><li><a href="{$share.url.pinterest}"><img src="typo3conf/ext/enzensberg/Resources/Public/images/md-icon.png" alt="img" /></a></li></ul>
