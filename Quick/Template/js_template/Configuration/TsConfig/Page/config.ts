...
RTE.classesAnchor {
	...
	more-link {
		class = more-link
		type = page
		titleText = LLL:EXT:js_template/Resources/Private/Language/locallang.xml:more_link_titleText
		altText = LLL:EXT:js_template/Resources/Private/Language/locallang.xml:more_link_altText
	}
	button-link {
		class = btn
		type = page
	...
	next-link {
		...
		type = page
		titleText = LLL:EXT:js_template/Resources/Private/Language/locallang.xml:next_link_titleText
		altText = LLL:EXT:js_template/Resources/Private/Language/locallang.xml:next_link_altText
	}
	back-link {
		class = back-link
		type = page
		titleText = LLL:EXT:js_template/Resources/Private/Language/locallang.xml:back_link_titleText
		altText = LLL:EXT:js_template/Resources/Private/Language/locallang.xml:back_link_altText
	}
}
...
RTE.default {
	...
	contentCSS = typo3conf/ext/js_template/Resources/Public/CSS/rte.css
