...
page.headerData.871.file = {$appleTouchIcon60}
page.headerData.871.stdWrap {
  wrap = <link href="|" rel="apple-touch-icon-precomposed" sizes="60x60" />
  required = 1
}

page.headerData.872 = IMG_RESOURCE
page.headerData.872.file = {$appleTouchIcon72}
...
page.headerData.873.file = {$appleTouchIcon76}
page.headerData.873.stdWrap {
  wrap = <link href="|" rel="apple-touch-icon-precomposed" sizes="76x76" />
  required = 1
}

page.headerData.874 = IMG_RESOURCE
page.headerData.874.file = {$appleTouchIcon114}
page.headerData.874.stdWrap {
  wrap = <link href="|" rel="apple-touch-icon-precomposed" sizes="114x114" />
  required = 1
}

page.headerData.875 = IMG_RESOURCE
page.headerData.875.file = {$appleTouchIcon120}
page.headerData.875.stdWrap {
  wrap = <link href="|" rel="apple-touch-icon-precomposed" sizes="120x120" />
  required = 1
}

page.headerData.876 = IMG_RESOURCE
page.headerData.876.file = {$appleTouchIcon144}
page.headerData.876.stdWrap {
  wrap = <link href="|" rel="apple-touch-icon-precomposed" sizes="144x144" />
  required = 1
}

page.headerData.877 = IMG_RESOURCE
page.headerData.877.file = {$appleTouchIcon152}
page.headerData.877.stdWrap {
  wrap = <link href="|" rel="apple-touch-icon-precomposed" sizes="152x152" />
  required = 1
}

page.headerData.878 = IMG_RESOURCE
page.headerData.878.file = {$appleTouchIcon180}
page.headerData.878.stdWrap {
  wrap = <link href="|" rel="apple-touch-icon-precomposed" sizes="180x180" />
  required = 1
}