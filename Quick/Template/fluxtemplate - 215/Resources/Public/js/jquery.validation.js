...
;(function (window, document, $, undefined) {
    ...
    _messages = {
        ...
        'INTEGER': '$ ist eine ganzzahlige.',
        'NUMERIC': '$ muss numerisch sein.',
        'MIXED': '$ m&uuml;ssen Buchstaben oder Zahlen sein (keine Sonderzeichen).',
        'NAME': '$ darf keine Sonderzeichen enthalten.',
        'NOSPACE': '$ darf keine Leerzeichen enthalten.',
        'TRIM': '$ darf nicht beginnen oder enden mit Leerzeichen.',
        'DATE': '$ ist kein gültiger mit Format YYYY-MM-DD.',
        'EMAIL': 'E-Mailadresse ist ung&uuml;ltig.',
        'URL': '$ ist ung&uuml;ltig.',
        'PHONE': '$ ist keine g&uuml;ltige Telefonnummer.',
        '<': '$ muss kleiner als % Zeichen.',
        '<=': '$ muss kleiner oder gleich % Zeichen sein.',
        '>': '$ must be greater than % characters.',
        '>=': '$ must be greater or equal to % characters.',
        '==': '$ must be equal to %',
        '!=': '$ muss anders als sein %'
    },
